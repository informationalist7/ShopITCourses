...
namespace ShopITCourses.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //Створення "нашого користувача ShopUser"
                var user = new ShopUser { UserName = Input.Email, Email = Input.Email, AdressDevivery = Input.AdressDevivery, FullName = Input.FullName };
